...
## Optional: Back Up Your Work

Your skills and worklogs are valuable — they're the institutional memory of your project. If you want to back them up:

- **Easiest:** Copy your project folder to a cloud drive (iCloud, Dropbox, Google Drive)
- **Best:** Set up a private GitHub repo. Claude can help you with this — just ask.
...
Built by Martha as part of [Project Bangka](https://github.com/marginmags/project-bangka).
